  ...
  return (
    <div className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
      <div className="relative">
        <img src={imagem} alt={nome} className="w-full h-72 object-cover" />
      ...
      <div className="p-6 flex flex-col justify-between flex-1">
        ...
        <Link
          to={`/receita/${id}`}
          className="mt-auto bg-orange-500 text-white py-2.5 rounded-xl hover:bg-orange-600 transition font-medium text-center"
        >
          Ver Receita
        </Link>
      </div>
